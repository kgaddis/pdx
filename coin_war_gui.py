...
class CoinWar(Frame):
    ...
    def __init__(self, root):
        ...
        self.text_box = Entry(self, width = 10)
        self.text_box.grid(row = 5, column = 1)
    ...
    # Method to get army assignments from file. File must be in
    # the same format as Bart's tests and located in the
